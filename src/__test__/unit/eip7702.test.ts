import { TRANSACTION_TYPE, EIP7702AuthTransaction, EIP7702AuthListTransaction } from '../../types';
...
describe('EIP-7702 Transaction Serialization', () => {
  ...
  test('serialization matches known good hash', () => {
    ...
    const tx: EIP7702AuthTransaction = {
      ...
      authorization: {
        chainId: 1,
        contractAddress: '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2', // WETH contract
        nonce: 0,
