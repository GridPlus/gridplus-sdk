export const ABI_TEST_VECTORS = [
  ...
  },
  {
    ...
    tx: {
      ...
      value: BigInt(0),
      data: '' as `0x${string}`,
      nonce: 0,
      maxFeePerGas: BigInt('20000000000'),
      maxPriorityFeePerGas: BigInt('2000000000'),
      gas: BigInt('500000'),
