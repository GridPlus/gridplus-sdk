...
const XRP_PAYMENT_SIGN_PREIMAGE = Buffer.from([
  0x53, 0x54, 0x58, 0x00, 0x12, 0x00, 0x00, 0x22, 0x80, 0x00, 0x00, 0x00,
  0x24, 0x00, 0x00, 0x00, 0x01, 0x61, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00,
  0x03, 0xe8, 0x68, 0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x73,
  0x21, 0xed, 0x5f, 0x5a, 0xc8, 0xb9, 0x89, 0x74, 0xa3, 0xca, 0x84, 0x33,
  0x26, 0xd9, 0xb8, 0x8c, 0xeb, 0xd0, 0x56, 0x01, 0x77, 0xb9, 0x73, 0xee,
  0x0b, 0x14, 0x9f, 0x78, 0x2c, 0xfa, 0xa0, 0x6d, 0xc6, 0x6a, 0x81, 0x14,
  0x5b, 0x81, 0x2c, 0x9d, 0x57, 0x73, 0x1e, 0x27, 0xa2, 0xda, 0x8b, 0x18,
  0x30, 0x19, 0x5f, 0x88, 0xef, 0x32, 0xa3, 0xb6, 0x83, 0x14, 0xb5, 0xf7,
...
describe('[XRP]', () => {
  ...
  beforeAll(async () => {
    ...
    const encodingTypes = fw?.genericSigning?.encodingTypes ?? {};
    const hashTypes = fw?.genericSigning?.hashTypes ?? {};
    const hasXrpEncoding = Boolean(encodingTypes?.XRP);
