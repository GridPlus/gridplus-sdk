...
describe('Test non-exportable seed on SafeCard', () => {
  ...
  it('Should test that ETH transaction sigs differ and validate on secp256k1', async () => {
    ...
    // Check sig 1
    expect(helpers.getSigStr(tx1Resp, tx)).to.not.equal(
    ...
    // Check sig 2
    expect(helpers.getSigStr(tx2Resp, tx)).to.not.equal(
    ...
    // Check sig 3
    expect(helpers.getSigStr(tx3Resp, tx)).to.not.equal(
      helpers.getSigStr(tx1Resp, tx),
    );
    expect(helpers.getSigStr(tx3Resp, tx)).to.not.equal(
      helpers.getSigStr(tx2Resp, tx),
    ...
    // Check sig 4
    expect(helpers.getSigStr(tx4Resp, tx)).to.not.equal(
      helpers.getSigStr(tx1Resp, tx),
    );
    expect(helpers.getSigStr(tx4Resp, tx)).to.not.equal(
      helpers.getSigStr(tx2Resp, tx),
    ...
    // Check sig 5
    expect(helpers.getSigStr(tx5Resp, tx)).to.not.equal(
      helpers.getSigStr(tx1Resp, tx),
    );
    expect(helpers.getSigStr(tx5Resp, tx)).to.not.equal(
      helpers.getSigStr(tx2Resp, tx),
  ...
  it('Should test that ETH message sigs differ and validate on secp256k1', async () => {
    ...
    // Check sig 1
    expect(helpers.getSigStr(msg1Resp)).to.not.equal(
      helpers.getSigStr(msg2Resp),
    );
    expect(helpers.getSigStr(msg1Resp)).to.not.equal(
      helpers.getSigStr(msg3Resp),
    );
    expect(helpers.getSigStr(msg1Resp)).to.not.equal(
      helpers.getSigStr(msg4Resp),
    );
    expect(helpers.getSigStr(msg1Resp)).to.not.equal(
      helpers.getSigStr(msg5Resp),
    );
    // Check sig 2
    expect(helpers.getSigStr(msg2Resp)).to.not.equal(
      helpers.getSigStr(msg1Resp),
    );
    expect(helpers.getSigStr(msg2Resp)).to.not.equal(
      helpers.getSigStr(msg3Resp),
    );
    ...
    // Check sig 3
    expect(helpers.getSigStr(msg3Resp)).to.not.equal(
      helpers.getSigStr(msg1Resp),
    );
    expect(helpers.getSigStr(msg3Resp)).to.not.equal(
      helpers.getSigStr(msg2Resp),
    ...
    // Check sig 4
    expect(helpers.getSigStr(msg4Resp)).to.not.equal(
      helpers.getSigStr(msg1Resp),
    );
    expect(helpers.getSigStr(msg4Resp)).to.not.equal(
      helpers.getSigStr(msg2Resp),
    ...
    // Check sig 5
    expect(helpers.getSigStr(msg5Resp)).to.not.equal(
      helpers.getSigStr(msg1Resp),
    );
    expect(helpers.getSigStr(msg5Resp)).to.not.equal(
      helpers.getSigStr(msg2Resp),
