...
function getSigStr(sig) {
  const v = (parseInt(sig.v.toString('hex'), 16) - 27).toString(16).padStart(2, '0');
...
describe('Compare personal_sign signatures vs Ledger vectors (1)', () => {
  ...
  it('Should validate signature from addr0', async () => {
    const expected =  '4820a558ab69907c90141f4857f54a7d71e7791f84478fef7b9a3e5b200ee242' + // r
                      ...
                      '01';                                                                // v
    msgReq.data.signerPath[2] = constants.HARDENED_OFFSET;
    try {
...
describe('Compare personal_sign signatures vs Ledger vectors (2)', () => {
  ...
  it('Should validate signature from addr0', async () => {
    const expected =  'b4fb4e0db168de42781ee1a27a1e907d5ec39aaccf24733846739f94f5b4542f' + // r
  ...
  it('Should validate signature from addr1', async () => {
    const expected =  '1318229681d8fcdf6db12819c8859501186a3c792543d38a38643c6f185dd252' + // r
  ...
  it('Should validate signature from addr8', async () => {
    const expected =  'c748f3fbf9f517fbd33462a858b40615ab6747295c27b4a46568d7d08c1d9d32' + // r
...
describe('Compare personal_sign signatures vs Ledger vectors (3)', () => {
  ...
  it('Should validate signature from addr0', async () => {
    const expected =  'f245100f07a6c695140fda7e29097034b3c97be94910639d20efdff5c96387fd' + // r
  ...
  it('Should validate signature from addr1', async () => {
    const expected =  '3a42c4955e4fb7ee2c4ee58df79c4be5f62839e691c169b74f90eafd371e2065' + // r
  ...
  it('Should validate signature from addr8', async () => {
    const expected =  '3e55dbb101880960cb32c17237d3ceb9d5846cf2f68c5c4c504cb827ea6a2e73' + // r
...
describe('Compare EIP712 signatures vs Ledger vectors (2)', () => {
  ...
  it('Should validate signature from addr0', async () => {
    const expected =  '0a1843ee1be7bf1ddd8bb32230ee3842b47022b8ba8795d3522db8a7341a9b85' + // r
  ...
  it('Should validate signature from addr1', async () => {
    const expected =  'f5284359479eb32eefe88bd24de59e4fd656d82238c7752e7a576b7a875eb5ae' + // r
  ...
  it('Should validate signature from addr8', async () => {
    const expected =  'f7a94b7ba7e0fbab88472cb77c5c255ba36e60e9f90bf4073960082bb5ef17cf' + // r
...
describe('Compare EIP712 signatures vs Ledger vectors (3)', () => {
  ...
  it('Should validate signature from addr0', async () => {
    const expected =  'c693714421acbba9fb8fdcd825295b6042802b06a55ae17a65db510dd5a348e0' + // r
  ...
  it('Should validate signature from addr1', async () => {
    const expected =  '4a32a478f6f772b37d8cfffabe8ee7c7956d45fd098035163c92b06564ead034' + // r
  ...
  it('Should validate signature from addr8', async () => {
    const expected =  '7a9f4e67309efb733fc4092f69f95583e06ccf4b25a364d9a9dc51b921edb464' + // r
...
describe('Test random personal_sign messages against JS signatures', () => {
  ...
  it.each(RANDOM_VEC_LABELS, 'Random sign_personal vector', ['label'], async (n, next) => {
    try {
      let res, jsSig, sig;
      const req = {
        currency: 'ETH_MSG',
